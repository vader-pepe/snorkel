        ...
        fs.readFile(requestFile, 'utf8', async (err, data) => {
            ...
            if (firstLine === '') {
                ...
                if (firstLine !== requestBefore) {
                    ...
                    await postToFacebook(process.env.FB_USER, process.env.FB_PASS, twitIMG, jsonData.caption);
                    await postToInstagram(process.env.IG_USER, process.env.IG_PASS, twitIMG, jsonData.caption);
